              ...
              <div className={styles.pdfContent}>
                ...
                <div className={styles.pdfInfoGrid}>
                  <div className={styles.pdfInfoCol}>
                    ...
                    <h5>{projectData.company || projectData.clientName}</h5>
                    {projectData.company && <div className={styles.pdfInfoRow}><span className="material-symbols-outlined">badge</span> {projectData.clientName}</div>}
                  ...
                  <div className={styles.pdfInfoCol}>
                    ...
                    <p style={{ marginTop: 8, color: 'var(--color-on-surface-variant)', fontSize: 13, lineHeight: 1.5 }}>
                      Pembuatan {projectData.projectName.toLowerCase()} responsif dengan fitur manajemen konten dan optimasi.
                    </p>
                    <div className={styles.pdfDuration} style={{ marginTop: 16, fontSize: 13 }}>
                      Estimated Duration: <strong style={{ color: themeColor }}>30 Hari Kerja</strong>
                    </div>
                  </div>
                </div>
                                ...
                                <tr key={subIdx} className={styles.subRow}>
                                  ...
                                  <td>
                                    <div className={styles.subTaskWrapper}>
                                      ...
                                      <div className={styles.subIndex}>{modIdx + 1}.{subIdx + 1}</div>
